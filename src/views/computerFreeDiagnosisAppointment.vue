        ...
        <div class="nei">
            ...
            <div class="bottom">
                <form>
                    ...
                    <div class="ser kong">
                        ...
                        <div>
                            <select class="inp" name="service" id="service">
                                ...
                                <option value="加装硬盘(自备)">加装硬盘(自备)</option>
                    ...
                    <div class="date kong">
                        <div><label for="date">预约日期</label></div>
                        <!-- 日期输入框容器，用于定位占位符 -->
                    ...
                    <div class="notice kong">
                        <p>注意事项：</p>
                        <ol>
                            <li>来之前请给电脑充好电</li>
                            <li>来维修请记得带好充电器</li>
                            <li>未过保机器发生损坏请优先选择售后，以防拒保</li>
                            <li>若您的电脑散热采用液金，我们无法提供清灰换硅脂服务，请到售后处理</li>
                        </ol>
                    </div>
...
<style scoped>
    /* 页面容器，设置全屏背景色 */
    .page-container {
        background-color: rgb(105, 0, 199);
        min-height: 100vh;
        width: 100%;
        display: flex;
