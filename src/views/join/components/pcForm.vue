  ...
  <div class="mx-4 sm:mx-[4rem] rounded-md bg-white">
    ...
    <div class="p-5 flex flex-col text-[#687281]">
      <a-form ref="formRef" layout="vertical" :model="enrolment" @submit="handleSubmit">
          ...
          <a-col :span="12">
            <a-form-item field="group" label="意向小组(参考)">
              <a-select placeholder="请选择你的意向小组" v-model="enrolment.group">
                <a-option value="未选择">未选择</a-option>
                <!-- <a-option value="程序设计组">网站组</a-option>
                ...
                <!-- <a-option value="开发组">开发组</a-option> -->
                <a-option value="嵌入式组">嵌入式组</a-option>
                <a-option value="短视频组">短视频组</a-option>
              </a-select>
            </a-form-item>
          </a-col>
          <a-col :span="12">
        ...
        <!-- <button disabled class="bg-blue-400 py-4 text-white font-bold rounded-full cursor-not-allowed">2023年秋季纳新已经结束, 我们下次再见</button> -->
